...
| `/스피드퀴즈` | 전용 채널에서 룬 효과로 이름 맞히기 시작 | `문제종목`(필수, 시즌2 전체·무기·방어구·앰블럼 룬 중 선택), `문제수`(최소 1, 기본 10, 출제 가능 수로 자동 조정), `제한시간`(문제당 초, 최소 1, 기본 30), `자음표시`(bool, 기본 false) |
